    ...
    var LazyLoadImg = function () {
        ...
        createClass(LazyLoadImg, [{
            ...
            value: function _start() {
                ...
                this._timer = setTimeout(function () {
                    ...
                    list.forEach(function (el) {
                        if (!el.getAttribute("LazyLoadImgState") && testMeet(el, options.position)) {
                            _this.loadImg(el);
                        }
                    });
                    _this._start();
            ...
            value: function loadImg(el) {
                ...
                el.setAttribute("LazyLoadImgState","start");
                // el.dataset.LazyLoadImgState = 'start';
                options.before.call(this, el);
                var img = new _win.Image();
                img.src = el.getAttribute("data-src");//el.dataset.src;
                // 图片加载成功
                img.addEventListener('load', function () {
                    ...
                    el.setAttribute("LazyLoadImgState","success");
                ...
                img.addEventListener('error', function () {
                    el.removeAttribute("data-src");
                    el.setAttribute("LazyLoadImgState","error");
                    // delete el.dataset.src;
        ...
        LazyLoadImg.init = function(options){
            var _options = _extends({
                ...
                error: function (el) { // 图片加载失败执行方法
                    el.src = ours.getContextPath() + "res_common/ours/ui/ui_pc/images/placeholder-image.png";
                }
            }, options);
